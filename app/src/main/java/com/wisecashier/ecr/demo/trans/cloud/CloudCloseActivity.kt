...
import kotlinx.android.synthetic.main.activity_cloud_close.*
import kotlinx.android.synthetic.main.activity_cloud_close.edit_input_description
import kotlinx.android.synthetic.main.activity_cloud_close.tv_btn_1
import kotlinx.android.synthetic.main.activity_cloud_close.tv_btn_2
import kotlinx.android.synthetic.main.activity_cloud_close.tv_btn_3
...
class CloudCloseActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_cloud_close)
        ...
        tv_btn_1.setOnClickListener {
            ...
            val parameters = mutableMapOf(
                ...
                "method" to InvokeConstant.CLOSE,
                // API owned parameters
                "description" to (if (edit_input_description.text.toString().isNotEmpty()) edit_input_description.text.toString() else "defaultDescription"),
